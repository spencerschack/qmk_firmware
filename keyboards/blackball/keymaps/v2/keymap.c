...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BAS] = LAYOUT(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                 ...
                 KC_LCMD, KC_SPC,  MO(SFT), KC_LOPT,      KC_NAV,                    KC_BSPC,
                                   MO(SYM), KC_ESC,                KC_TAB,  KC_ENT
    ),
    [SFT] = LAYOUT(
        _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,      _______, _______, KC_QUOT, S(KC_QUOT), _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (layer_state_is(SFT)) {
        if (keymaps[SFT][record->event.key.row][record->event.key.col] == KC_TRNS) {
            if (record->event.pressed) {
